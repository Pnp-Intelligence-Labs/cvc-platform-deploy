"""
config.py — Shared configuration for all CVC skills.
...
# Usage: from llm.openrouter import call; call(prompt, model=MODEL_KIMI_K2_5)
...
OPENAI_EMBED_MODEL = "text-embedding-3-small"  # 1536-dim, matches cvc.companies.embedding
...
# ── Monitoring ────────────────────────────────────────────────────────────────
MONITOR_DB    = Path.home() / ".cvc-skills" / "metrics.db"
