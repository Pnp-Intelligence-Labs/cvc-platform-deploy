"""
api/routes/trend_reports.py — Report Workspace
===============================================
Prefix: /reports  (set in main.py)
...
_REPORT_UPLOAD_DIR = "/home/nathan11/repos/cvc-intelligence/api/static/report_sources"
...
def _fetch_url_content(url: str) -> tuple[str, str]:
    ...
    headers = {
        'User-Agent': 'Mozilla/5.0 (compatible; SLAMResearch/1.0; +https://plugandplaytechcenter.com)',
            ...
            "suggestions": [
                {
                    ...
                    "rationale": "Shows CVC portfolio concentration — good for portfolio construction sections",
...
def _generate_section_bg(report_id: int, section_id: int):
    ...
    try:
        import sys
        sys.path.insert(0, '/home/nathan11/repos/cvc-intelligence')
...
def download_docx(report_id: int, user: UserInfo = Depends(require_jwt)):
    ...
    filename = f"{safe_title}_SLAM_Report.docx"
